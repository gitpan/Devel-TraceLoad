# This Makefile is for the Devel::TraceLoad extension to perl.
#
...
#	NAME => q[Devel::TraceLoad]
#	VERSION_FROM => q[lib/Devel/TraceLoad.pm]
#	clean => { FILES=>q[err] }
...
AR_STATIC_ARGS = cr
NAME = Devel::TraceLoad
DISTNAME = Devel-TraceLoad
NAME_SYM = Devel_TraceLoad
VERSION = 0.05
VERSION_SYM = 0_05
XS_VERSION = 0.05
INST_BIN = blib\bin
...
FULLEXT = Devel\TraceLoad
BASEEXT = TraceLoad
PARENT_NAME = Devel
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Devel/TraceLoad.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
EXPORT_LIST = TraceLoad.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = lib/Devel/TraceLoad.pm

PM_TO_BLIB = lib/Devel/TraceLoad.pm \
	$(INST_LIB)\Devel\TraceLoad.pm
...
$(INST_AUTODIR)\.exists :: D:\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_AUTODIR)
	@$(EQUALIZE_TIMESTAMP) D:\Perl\lib\CORE\perl.h $(INST_AUTODIR)\.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_AUTODIR)

$(INST_LIBDIR)\.exists :: D:\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_LIBDIR)
	@$(EQUALIZE_TIMESTAMP) D:\Perl\lib\CORE\perl.h $(INST_LIBDIR)\.exists

	-@$(CHMOD) $(PERM_RWX) $(INST_LIBDIR)

$(INST_ARCHAUTODIR)\.exists :: D:\Perl\lib\CORE\perl.h
	@$(MKPATH) $(INST_ARCHAUTODIR)
	@$(EQUALIZE_TIMESTAMP) D:\Perl\lib\CORE\perl.h $(INST_ARCHAUTODIR)\.exists
...
TraceLoad.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Devel::TraceLoad', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
clean ::
	-$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_rf err ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core core.*perl.*.? *perl.core so_locations pm_to_blib *~ */*~ */*/*~ *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIB)\Devel\TraceLoad.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Devel-TraceLoad\" VERSION=\"0,05,0,0\">\n}. qq{\t<TITLE>Devel-TraceLoad</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Devel-TraceLoad.ppd
